//
// File generated by rootcint at Fri Nov 24 11:36:38 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridTrackSummary*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("IngridTrackSummary", ::IngridTrackSummary::Class_Version(), "././IngridTrackSummary.h", 20,
                  typeid(::IngridTrackSummary), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::IngridTrackSummary*)
   {
...
atomic_TClass_ptr IngridTrackSummary::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::IngridTrackSummary*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int IngridTrackSummary::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::IngridTrackSummary*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void IngridTrackSummary::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::IngridTrackSummary*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *IngridTrackSummary::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::IngridTrackSummary*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::IngridTrackSummary
...
/* IngridTrackSummary */
static int G__IngridTrackSummaryDict_202_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   IngridTrackSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__IngridTrackSummaryDict_202_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridTrackSummary*) G__getstructoffset())->NHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridTrackSummary*) G__getstructoffset())->NSimParticles());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridTrackSummary*) G__getstructoffset())->NSimEMShowers());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridTrackSummary*) G__getstructoffset())->GetIngridHit((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridTrackSummary*) G__getstructoffset())->GetSimParticle((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridTrackSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridTrackSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridTrackSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridTrackSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridTrackSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridTrackSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridTrackSummaryDict_202_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridTrackSummaryDict_202_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridTrackSummaryDict_202_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarIngridTrackSummary(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncIngridTrackSummary(void) {
   ...
   G__memfunc_setup("IngridTrackSummary",1856,G__IngridTrackSummaryDict_202_0_1, 105, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridTrackSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IngridTrackSummary",1856,G__IngridTrackSummaryDict_202_0_2, 105, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridTrackSummary), -1, 0, 1, 1, 1, 0, "u 'IngridTrackSummary' - 11 - trk", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridTrackSummaryDict_202_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NHits",486,G__IngridTrackSummaryDict_202_0_5, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimParticles",1310,G__IngridTrackSummaryDict_202_0_6, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimEMShowers",1268,G__IngridTrackSummaryDict_202_0_7, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridHit",1163,G__IngridTrackSummaryDict_202_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridHitSummary' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridHit",1186,G__IngridTrackSummaryDict_202_0_9, 85, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridHitSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddSimParticle",1382,G__IngridTrackSummaryDict_202_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridSimParticleSummary' - 0 - part", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSimParticle",1405,G__IngridTrackSummaryDict_202_0_11, 85, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridSimParticleSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridTrackSummaryDict_202_0_12, 85, G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&IngridTrackSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__IngridTrackSummaryDict_202_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridTrackSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridTrackSummaryDict_202_0_14, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&IngridTrackSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridTrackSummaryDict_202_0_15, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&IngridTrackSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridTrackSummaryDict_202_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridTrackSummaryDict_202_0_20, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridTrackSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridTrackSummaryDict_202_0_21, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridTrackSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridTrackSummaryDict_202_0_22, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridTrackSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridTrackSummaryDict_202_0_23, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridTrackSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~IngridTrackSummary", 1982, G__IngridTrackSummaryDict_202_0_24, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridTrackSummaryDict_202_0_25, (int) ('u'), G__get_linked_tagnum(&G__IngridTrackSummaryDictLN_IngridTrackSummary), -1, 1, 1, 1, 1, 0, "u 'IngridTrackSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
