...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridSimParticleSummary*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("IngridSimParticleSummary", ::IngridSimParticleSummary::Class_Version(), "././IngridSimParticleSummary.h", 9,
                  typeid(::IngridSimParticleSummary), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::IngridSimParticleSummary*)
   {
...
atomic_TClass_ptr IngridSimParticleSummary::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::IngridSimParticleSummary*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int IngridSimParticleSummary::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::IngridSimParticleSummary*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void IngridSimParticleSummary::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::IngridSimParticleSummary*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *IngridSimParticleSummary::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::IngridSimParticleSummary*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::IngridSimParticleSummary
...
static void G__setup_memvarIngridSimParticleSummary(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__IngridSimParticleSummaryDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
