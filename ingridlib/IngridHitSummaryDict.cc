//
// File generated by rootcint at Fri Nov 24 11:36:30 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::IngridHitSummary*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("IngridHitSummary", ::IngridHitSummary::Class_Version(), "././IngridHitSummary.h", 16,
                  typeid(::IngridHitSummary), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::IngridHitSummary*)
   {
...
atomic_TClass_ptr IngridHitSummary::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::IngridHitSummary*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int IngridHitSummary::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::IngridHitSummary*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void IngridHitSummary::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::IngridHitSummary*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *IngridHitSummary::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::IngridHitSummary*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::IngridHitSummary
...
/* IngridHitSummary */
static int G__IngridHitSummaryDict_200_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_200_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   IngridHitSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__IngridHitSummaryDict_200_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_200_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((IngridHitSummary*) G__getstructoffset())->Pe());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const IngridHitSummary*) G__getstructoffset())->NSimHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_200_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const IngridHitSummary*) G__getstructoffset())->GetIngridSimHit((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) IngridHitSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) IngridHitSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_200_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_200_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) IngridHitSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) IngridHitSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__IngridHitSummaryDict_200_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__IngridHitSummaryDict_200_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__IngridHitSummaryDict_200_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarIngridHitSummary(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__IngridHitSummaryDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncIngridHitSummary(void) {
   ...
   G__memfunc_setup("IngridHitSummary",1648,G__IngridHitSummaryDict_200_0_1, 105, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IngridHitSummary",1648,G__IngridHitSummaryDict_200_0_2, 105, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 0, 1, 1, 1, 0, "u 'IngridHitSummary' - 11 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__IngridHitSummaryDict_200_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Pe",181,G__IngridHitSummaryDict_200_0_5, 102, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NSimHits",783,G__IngridHitSummaryDict_200_0_6, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddIngridSimHit",1460,G__IngridHitSummaryDict_200_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "U 'IngridSimHitSummary' - 0 - hit", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIngridSimHit",1483,G__IngridHitSummaryDict_200_0_8, 85, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridSimHitSummary), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__IngridHitSummaryDict_200_0_9, 85, G__get_linked_tagnum(&G__IngridHitSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&IngridHitSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__IngridHitSummaryDict_200_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridHitSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__IngridHitSummaryDict_200_0_11, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&IngridHitSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__IngridHitSummaryDict_200_0_12, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&IngridHitSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__IngridHitSummaryDict_200_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__IngridHitSummaryDict_200_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridHitSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__IngridHitSummaryDict_200_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridHitSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__IngridHitSummaryDict_200_0_19, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&IngridHitSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__IngridHitSummaryDict_200_0_20, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&IngridHitSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~IngridHitSummary", 1774, G__IngridHitSummaryDict_200_0_21, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__IngridHitSummaryDict_200_0_22, (int) ('u'), G__get_linked_tagnum(&G__IngridHitSummaryDictLN_IngridHitSummary), -1, 1, 1, 1, 1, 0, "u 'IngridHitSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
