//
// File generated by rootcint at Fri Nov 24 11:36:33 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::BeamInfoSummary*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BeamInfoSummary", ::BeamInfoSummary::Class_Version(), "././BeamInfoSummary.h", 18,
                  typeid(::BeamInfoSummary), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::BeamInfoSummary*)
   {
...
atomic_TClass_ptr BeamInfoSummary::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::BeamInfoSummary*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int BeamInfoSummary::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::BeamInfoSummary*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void BeamInfoSummary::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::BeamInfoSummary*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *BeamInfoSummary::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::BeamInfoSummary*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::BeamInfoSummary
...
/* BeamInfoSummary */
static int G__BeamInfoSummaryDict_199_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_199_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   BeamInfoSummary* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__BeamInfoSummaryDict_199_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_199_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) BeamInfoSummary::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_199_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_199_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) BeamInfoSummary::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_199_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_199_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_199_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_199_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) BeamInfoSummary::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_199_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BeamInfoSummary::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BeamInfoSummaryDict_199_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BeamInfoSummaryDict_199_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BeamInfoSummaryDict_199_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarBeamInfoSummary(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncBeamInfoSummary(void) {
   ...
   G__memfunc_setup("BeamInfoSummary",1519,G__BeamInfoSummaryDict_199_0_1, 105, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BeamInfoSummary",1519,G__BeamInfoSummaryDict_199_0_2, 105, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 0, 1, 1, 1, 0, "u 'BeamInfoSummary' - 11 - info", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Clear",487,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 '\"\"' option", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Print",525,G__BeamInfoSummaryDict_199_0_4, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__BeamInfoSummaryDict_199_0_5, 85, G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&BeamInfoSummary::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__BeamInfoSummaryDict_199_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BeamInfoSummary::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__BeamInfoSummaryDict_199_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&BeamInfoSummary::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__BeamInfoSummaryDict_199_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&BeamInfoSummary::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__BeamInfoSummaryDict_199_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__BeamInfoSummaryDict_199_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BeamInfoSummary::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__BeamInfoSummaryDict_199_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BeamInfoSummary::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__BeamInfoSummaryDict_199_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BeamInfoSummary::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__BeamInfoSummaryDict_199_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BeamInfoSummary::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~BeamInfoSummary", 1645, G__BeamInfoSummaryDict_199_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BeamInfoSummaryDict_199_0_18, (int) ('u'), G__get_linked_tagnum(&G__BeamInfoSummaryDictLN_BeamInfoSummary), -1, 1, 1, 1, 1, 0, "u 'BeamInfoSummary' - 11 - -", (char*) NULL, (void*) NULL, 0);
